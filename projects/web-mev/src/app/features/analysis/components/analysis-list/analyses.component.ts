...
export class AnalysesComponent implements OnInit {
  ...
  //   this.apiService.getAvailableResourcesByParam(this.resourceField1.type, this.workspaceId).subscribe(data => {
  ...
  //   this.apiService.getAvailableResourcesByParam(this.multipleResourceField1.type, this.workspaceId).subscribe(data => {
  //     this.multipleResourceField1.files = data;
  //   });

  //   this.textField1.key = 'output_filename';
  //   this.textField1.name = 'Output file name: ';
  //   this.textField1.desc = 'The name of the output file of differentially expressed genes. We will automatically add \".tsv\" to the end.';
