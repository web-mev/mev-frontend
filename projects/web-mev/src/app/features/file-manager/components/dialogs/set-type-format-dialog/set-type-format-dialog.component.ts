 ...
 */
@Component({
  selector: 'mev-set-type-format-dialog',
  templateUrl: './set-type-format-dialog.component.html',
  styleUrls: ['./set-type-format-dialog.component.scss']
})
export class SetTypeFormatDialogComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<SetTypeFormatDialogComponent>,
