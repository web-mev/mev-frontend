...
@Component({
  selector: 'tcga-methylation-explorer',
  templateUrl: './tcga-methylation.component.html',
  styleUrls: ['./tcga-methylation.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class TcgaMethylationComponent extends GdcRnaseqComponent implements OnChanges, OnInit {
  @Input() query: string = "";
  datasetTag = 'tcga-methylation';
  ...
  checkboxSelectionTCGA(event, name: string, category) {
    if (event['checked']) {
      ...
      this.publicDataSetComponent.checkboxStatus['tcga-methylation'][category][name] = true;
      ...
      this.publicDataSetComponent.checkboxStatus['tcga-methylation'][category][name] = false;
    }
    this.getCurrentCount();
  }
